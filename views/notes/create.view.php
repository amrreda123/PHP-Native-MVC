            ...
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Write down your thoughts or tasks. Everything is private to you.
                    </p>
                </div>
            </div>

            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" class="shadow sm:rounded-md overflow-hidden">
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <textarea 
                                        ...
                                        name="body" 
                                        rows="5" 
                                        class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?= isset($errors['body']) ? 'border-red-500' : 'border-gray-300' ?>" 
                                        placeholder="What's on your mind?"><?= $_POST['body'] ?? '' ?></textarea>
